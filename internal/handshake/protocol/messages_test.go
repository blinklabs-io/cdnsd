...
func TestMsgGetProofEncodeDecode(t *testing.T) {
	testDefs := []struct {
		message   Message
		binaryHex string
	}{
		// Generated by our own code
		{
			binaryHex: "60847e88c962c5112a25bb30bb2317cf36cde1e1cb28670c673476b3911cd50866d0eae73152781048a2d83dd103a6dc155d162e72fba88d055f32d99580cef8",
			message: &MsgGetProof{
				Root: func() [32]byte {
					foo, _ := hex.DecodeString("60847e88c962c5112a25bb30bb2317cf36cde1e1cb28670c673476b3911cd508")
					return [32]byte(foo)
				}(),
				Key: func() [32]byte {
					foo, _ := hex.DecodeString("66d0eae73152781048a2d83dd103a6dc155d162e72fba88d055f32d99580cef8")
					return [32]byte(foo)
				}(),
			},
		},
...
func TestMsgGetDataEncodeDecode(t *testing.T) {
	testDefs := []struct {
		...
		// Generated by our own code
		{
			binaryHex: "010200000000000000000002419d1ed702c9bd9f83ca3f7b9aa7ab6bf4eb01f2f0c47f5ccc",
			message: &MsgGetData{
				Inventory: []InvItem{
					{
						Type: InvTypeBlock,
						Hash: func() [32]byte {
							foo, _ := hex.DecodeString("00000000000002419d1ed702c9bd9f83ca3f7b9aa7ab6bf4eb01f2f0c47f5ccc")
							return [32]byte(foo)
						}(),
					},
				},
